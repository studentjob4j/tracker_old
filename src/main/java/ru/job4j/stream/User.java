...
/**
 * Шаблон проектирования в stream api - builder
...
public class User {
    ...
    public String toString() {
        return "User{" + "name='" + name + '\'' + ", surname='" + surname + '\'' + ", age=" + age
                ...
                + ", activated=" + activated + ", gender='" + gender + '\'' + '}';
    }
    ...
    public static void main(String[] args) {
        User user = new Builder().buildName("name").buildSurname("surname")
                .buildAge((byte) 10).buildActivated(true).buildGender("male")
                .buildLogin("login").buildPassword("123").build();
